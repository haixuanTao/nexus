...
//!
//! Run: cargo run -p pendulum_headless --bin pendulum_batch --release [N] [seed]
...
async fn webgpu_backend() -> KhalGpuBackend {
    ...
    let mut webgpu = WebGpu::new(wgpu::Features::default(), limits).await.expect("webgpu");
...
fn main() {
    ...
    pollster::block_on(async {
        ...
        for _ in 0..n {
            ...
            all_b.push(b); all_c.push(c); all_mb.push(mb); starts.push(u);
        }
