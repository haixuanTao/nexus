"""Python port of `crates/examples3d/boxes_and_balls3.rs`. Falling cuboids and balls (alternating by row) in a walled box.

Run with:

    maturin develop -m crates/nexus_python3d/Cargo.toml --features metal
    python crates/nexus_python3d/examples/boxes_and_balls3.py
"""
